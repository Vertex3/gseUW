call C:\Apps\Gizinta\gseUW\ETL\BldgOutline_sync_UWB.bat
if %ERRORLEVEL% NEQ 0 EXIT /B %ERRORLEVEL%
call C:\Apps\Gizinta\gseUW\ETL\Floorplan_sync_UWB.bat
if %ERRORLEVEL% NEQ 0 EXIT /B %ERRORLEVEL%
call C:\Apps\Gizinta\gseUW\ETL\Publication_sync.bat
call C:\Apps\Gizinta\gseUW\ETL\Routing_Sync_UWB.bat
if %ERRORLEVEL% NEQ 0 EXIT /B %ERRORLEVEL%
